...
const TeamMember: React.FC<TeamMemberProps> = ({ image, name, role, linkedin, mail }) => {
  return (
    <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all group px-4 py-6 sm:p-6">
      <div className="flex flex-col items-center text-center">
        <div className="w-32 h-32 sm:w-40 sm:h-40 rounded-full overflow-hidden mb-4 ring-4 ring-blue-100 group-hover:ring-blue-200 transition-all">
          <img 
            src={image} 
            alt={name} 
        ...
        <p className="text-sm sm:text-base text-blue-600 font-medium mb-3">{role}</p>
        <div className="flex gap-3">
          <a 
            href={linkedin}
            className="w-8 h-8 flex items-center justify-center rounded-full bg-blue-50 text-blue-600 hover:bg-blue-100 hover:text-blue-700 transition-colors border border-blue-100"
    ...
    <section id="about" className="py-20 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto mb-16">
          <h2 className="text-2xl md:text-3xl font-bold mt-4 mb-6 text-gray-900">
            Our Team
          </h2>
          <p className="text-gray-600 text-xl leading-relaxed">
            Our diverse team of AI specialists and industry experts is dedicated to helping you achieve your goals.
          </p>
        </div>

        {/* Navigation Arrows - Centered with respect to carousel */}
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 overflow-visible flex flex-col items-center">
          <div className="w-full relative flex items-center justify-center">
            <button
              onClick={prevSlide}
              className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-1/2 z-10 w-14 h-14 bg-white rounded-full shadow-lg flex items-center justify-center text-gray-600 hover:text-blue-600 hover:shadow-xl transition-all group border border-gray-200"
            ...
            {/* Carousel Track */}
            <div className="overflow-hidden px-4 sm:px-8 md:px-16 w-full">
              <div
            ...
            <button
              onClick={nextSlide}
              className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 z-10 w-14 h-14 bg-white rounded-full shadow-lg flex items-center justify-center text-gray-600 hover:text-blue-600 hover:shadow-xl transition-all group border border-gray-200"
