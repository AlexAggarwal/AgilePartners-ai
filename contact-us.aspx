<%@ Page Title="Contact Us | Agile Partners" Language="C#" MasterPageFile="~/MasterPage.master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <img src="images/contactus.jpg" style="margin: 5px 0 0 5px;" alt="Contact Us" title="Contact Us" />
    <p>
    ...
    <asp:UpdatePanel ID="udpgellary" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
            <table width="360" cellspacing="0" cellpadding="2" border="0" align="left">
                <tbody>
                    <tr>
                    ...
                    <tr valign="middle">
                        ...
                        <td>
                            <asp:TextBox ID="txtCountry" runat="server" MaxLength="5" Width="187px" TabIndex="6"
                                ToolTip="Country Name" CssClass="body_text"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvCountry" runat="server" ValidationGroup="submit"
                                ControlToValidate="txtCountry" ErrorMessage="Country name is required." Display="None"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr valign="middle">
                        <td align="right">
                    ...
                    <tr valign="middle">
                        ...
                        <td>
                            <asp:DropDownList ID="ddlAboutUs" TabIndex="9" ToolTip="How did you hear about us?"
                                runat="server" AutoPostBack="true" CssClass="body_text" OnSelectedIndexChanged="ddlAboutUs_SelectedIndexChanged">
                            ...
                            <asp:TextBox ID="txtHearAboutUs" runat="server" Width="159px" Enabled="false" MaxLength="200"
                                TabIndex="10" ToolTip="How did you hear about us?" CssClass="body_text"></asp:TextBox>
                    ...
                    <tr valign="middle">
                        ...
                        <td>
                            <asp:DropDownList ID="ddlCategory" TabIndex="11" ToolTip="Category" runat="server"
                                CssClass="body_text">
                                <asp:ListItem Text="Select" Value="0"></asp:ListItem>
                    ...
                    <tr valign="middle">
                        ...
                        <td>
                            <asp:TextBox ID="txtComment" runat="server" TextMode="MultiLine" Height="175px" Width="232px"
                                TabIndex="12" ToolTip="Your Comments" CssClass="body_text"></asp:TextBox>
                        ...
                        <td valign="middle">
                            <table cellspacing="0" cellpadding="0" border="0">
                                <tbody>
                                    <tr>
                                        <td valign="top">
                                            <asp:TextBox ID="txtVerificationCode" runat="server" Width="90px" TabIndex="13" ToolTip="Verification Code"
                                                CssClass="body_text"></asp:TextBox>
                    ...
                    <tr valign="middle">
                        ...
                        <td>
                            <asp:ImageButton ID="imgbtnSubmit" runat="server" Width="87px" ToolTip="Submit" TabIndex="14"
                                Height="28px" ValidationGroup="submit" CausesValidation="true" ImageUrl="~/images/submitBtn.jpg"
                                OnClick="imgbtnSubmit_Click" />
                            <asp:ImageButton ID="imgbtnReset" runat="server" Width="87px" TabIndex="15" ToolTip="Reset"
			...
			<div class="address">
															<h2 class="subTitle" style="padding:0; margin:0;">
															<img src="images/office-icon.png" align="absmiddle" alt="" title="" />&nbsp;Corporate Office</h2>
															<strong>AGILE PARTNERS INC.</strong><br />
																Suite #101,<br />
																49655 West Central Park,<br />
